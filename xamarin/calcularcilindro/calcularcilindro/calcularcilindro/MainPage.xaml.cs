...
namespace calcularcilindro
{
    public partial class MainPage : ContentPage
    {
        ...
        private void Button_Clicked(object sender, EventArgs e)
        {
            ...
            DisplayAlert("El Apriete es de:", AprieteMilecimas + "Milecimas de Pulgada +- " + Tolerancia + "mm de pulgadas " + " --" + "Es necesario calentar el monoblock hasta los:  " + TemEnc + " grados centigrados+-  " + ToLo + "ºC",
                         "ok");
